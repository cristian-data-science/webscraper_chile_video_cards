...
tn = pd.read_csv('/home/ubuntu/gitprojects/webscraper_chile_video_cards/video_cards/video_cards/resultados/tecnofinal.csv', encoding="latin-1")
tn = tn.assign(tienda= 'tecno master')
test = pd.concat([pc, sp, wp, tn ])
...
lista_tarjetas = ['1050TI','1050','1650TI','1650 TI','1650','1660TI','1660 TI','1660S','1660','2060S','2060','2070S','2070', '2080S','2080', '2080TI','2080 TI','2080', '3050', '3060TI','3060 TI', '3060','3070TI','3070 TI', '3070','3080TI','3080 TI', '3080','3090 TI','3090TI','3090','6500XT','6500 XT','6600XT','6600 XT','6600','6700XT','6700 XT','6700','6800 XT','6800XT','6800','6900XT','6900 XT']
